...
//    }
    ...
    @Rule(desc = "Fixes instant scheduling (also known as instant tile tick) causing server crashes", category = FIX)
    public static boolean instantSchedulingCrashFix = false;
