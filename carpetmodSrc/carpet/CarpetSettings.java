...
public class CarpetSettings
{
  ...
  rule("commandDebugChunks",    "commands", "Record chunk loading/unloading for a given area for later examination").defaultTrue(),
  ...
  rule("pushLimit",             "creative","Customizable piston push limit")
                                .choices("12","10 12 14 100").setNotStrict(),
